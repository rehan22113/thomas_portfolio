...
const Navbar = () => {
  ...
  <div className="container w-[95%] mx-auto flex flex-wrap px-5 py-2 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      <HashLink to="/" className="mr-5 hover:text-gray-300">Home</HashLink>
      <HashLink to="/about" className="mr-5 hover:text-gray-300">About us</HashLink>
      {/* <HashLink to="/#milestone" className="mr-5 hover:text-gray-300">Milestone</HashLink> */}
      <HashLink to="/#service" className="mr-5 hover:text-gray-300">Services</HashLink>
